...
public class AlbumGridAdapter extends ArrayAdapter<AlbumGrid> {
    ...
    public AlbumGridAdapter(Context context, ArrayList<AlbumGrid> albumGrids) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String artistsId = currentAlbum.getArtistId();
        ...
        // Gets the album title in the current position
        String albumText = currentAlbum.getAlbumText();
        // Checks if length of album title is longer than 20 CHAR and limits it true
        if (albumTextLength > 20) {
            albumText = albumText.substring(0, 20);
        ...
        String artistText = currentAlbum.getArtistText();
